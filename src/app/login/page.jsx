...
export default function Login() {
  ...
  const handleSubmit = (data) =>{
    ...
    postRequest("http://localhost:2020/api/login",payload).then((response)=>{
              ...
              <Form action="#" className="flex flex-col space-y-5">
                ...
                <div className="flex flex-col relative space-y-1">
                  ...
                  <Field
                    ...
                    className="px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-blue-200"
                  />
                  <i className="bi bi-eye absolute" id="Eyeicon" onClick={showPasswordToggle} style={{top: '30px',right: '10px'}}></i>
