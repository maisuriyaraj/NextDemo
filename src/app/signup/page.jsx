...
// Important use Only from "next/navigation"
...
export default function SignUp() {
  ...
  const validationSchema = object({
    ...
    password: string().min(4, "Your Password must be 4 to 8 characters long !.").max(8, "Your Password must be 4 to 8 characters long !.").required("Password is Required !!"),
  ...
  const handleSubmit = (data) =>{
    ...
    postRequest("http://localhost:2020/api/register",payload).then((response)=>{
              ...
              <Form action="#" className="flex flex-col space-y-5">
                ...
                <div className="flex flex-col space-y-5">
                  <span className="flex items-center justify-center space-x-2">
                    ...
                    <span className="font-normal text-gray-500">or Create with</span>
                    <span className="h-px bg-gray-400 w-14" />
                  </span>
